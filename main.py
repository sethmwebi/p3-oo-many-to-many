...
class Student:
    ...
    def enrollments(self):
        return [
            enrollment for enrollment in Enrollment.all if enrollment.student == self
        ]
...
class Course:
    ...
    def enrollments(self):
        return [
            enrollment for enrollment in Enrollment.all if enrollment.course == self
        ]
...
student = Student("Seth")
course = Course("Econ 101")
